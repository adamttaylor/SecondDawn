...
<?php if ( bbp_current_user_can_access_create_topic_form() ) : ?>
	...
	<div id="new-topic-<?php bbp_topic_id(); ?>" class="bbp-topic-form<?php echo (bbp_topics()? ' hastopics':'');?>">
		<?php if(bbp_topics()){ echo '<div class="close">X</div>'; }?>
		<form id="new-post" name="new-post" method="post" action="<?php the_permalink(); ?>">
			...
			<fieldset class="bbp-form">
				...
				<div>
					...
					<p>
						<input type="text" id="bbp_topic_title" value="<?php bbp_form_topic_title(); ?>" tabindex="<?php bbp_tab_index(); ?>" size="40" name="bbp_topic_title" maxlength="<?php bbp_title_max_length(); ?>" placeholder="Enter Title Here"/>
					</p>
					...
					<?php if ( bbp_allow_topic_tags() && current_user_can( 'assign_topic_tags' ) ) : ?>
						...
						<p>
							<input type="text" value="<?php bbp_form_topic_tags(); ?>" tabindex="<?php bbp_tab_index(); ?>" size="40" name="bbp_topic_tags" id="bbp_topic_tags" <?php disabled( bbp_is_topic_spam() ); ?> placeholder="Enter Tags here"/>
						</p>
					...
					<?php if ( current_user_can( 'moderate' ) ) : ?>
						...
						<div>
                            ...
                            <div class="second-tier">
                                ...
                                <label for="bbp_topic_status"><?php _e( 'Status:', 'bbpress' ); ?></label>
					...
					<?php if ( bbp_allow_revisions() && bbp_is_topic_edit() ) : ?>
						...
						<fieldset class="bbp-form edit-log">
							<legend>
					...
					<div class="bbp-submit-wrapper">
						...
						<button class="blue" type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_topic_submit" name="bbp_topic_submit" class="button submit"><?php _e( 'Submit', 'bbpress' ); ?></button>
