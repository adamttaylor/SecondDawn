		...
		$compilepopular .= '
			<li '.((has_post_thumbnail()) ? '' : 'class="no_img"').'>';
                if (has_post_thumbnail()) {
                    $compilepopular .= '<div class="recent_posts_img"><img src="'.aq_resize($featured_image_latest[0], "160", "160", true, true, true).'" alt="'.get_the_title().'"></div>';
                }
...
$compilepopular .= '
                <div class="recent_posts_content">
                    <a class="post_title read_more" href="'.get_permalink().'"><h5>'.get_the_title().'</h5></a>
					<div class="widget_posts_date">'. get_the_time("F d, Y") .'</div>
