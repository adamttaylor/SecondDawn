...
?>
    ...
    <div class="content_wrapper image">
        <div class="container">
            <div class="content_block <?php echo $gt3_theme_pagebuilder['settings']['layout-sidebars'] ?> row">
                <div
                    ...
                    <div class="row">
                        <div
                            class="gallery_page blog_post_preview posts-block <?php echo(($gt3_theme_pagebuilder['settings']['layout-sidebars'] == "left-sidebar" || $gt3_theme_pagebuilder['settings']['layout-sidebars'] == "right-sidebar") ? "span9" : "span12"); ?>">
										...
										<div class="blog_post_page portfolio_post blog_post_content">      
                                            ...
                                            <section class="blog_post-topline">
	                                            <?php if ( has_excerpt() ) : ?>
                                                 ...
                                                 <?php endif; ?>
                                                <div class="blog_post-meta preview_meta">
													<?php
