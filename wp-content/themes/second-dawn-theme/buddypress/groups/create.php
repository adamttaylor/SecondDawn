	...
	<form action="<?php bp_group_creation_form_action(); ?>" method="post" id="create-group-form" class="standard-form" enctype="multipart/form-data">
		...
		<div class="item-body" id="group-create-body">
			...
			<?php if ( bp_is_group_creation_step( 'group-details' ) ) : ?>
				...
				<div>
					<input type="text" name="group-name" id="group-name" aria-required="true" placeholder="Group Name" value="<?php bp_new_group_name(); ?>" />
				</div>

				<div>
					<textarea name="group-desc" id="group-desc" aria-required="true" placeholder="Description"><?php bp_new_group_description(); ?></textarea>
				</div>
