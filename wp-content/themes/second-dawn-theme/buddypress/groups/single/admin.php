...
<?php if ( bp_is_group_admin_screen( 'manage-members' ) ) : ?>
	...
	<div class="bp-widget">
		<h2 class="white-title"><?php _e( 'Administrators', 'buddypress' ); ?></h2>
	...
	<?php if ( bp_group_has_moderators() ) : ?>
		<div class="bp-widget">
			<h2 class="white-title" style="margin-top:10px"><?php _e( 'Moderators', 'buddypress' ); ?></h2>
	...
	<div class="bp-widget">
		<h2 class="white-title" style="margin-top:10px"><?php _e("Members", "buddypress"); ?></h2>
