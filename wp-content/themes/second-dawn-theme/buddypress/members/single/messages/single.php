<div id="message-thread" role="main">
	...
	<?php if ( bp_thread_has_messages() ) : ?>
		...
		<?php while ( bp_thread_messages() ) : bp_thread_the_message(); ?>
			...
			<ul class="message-box item-list <?php bp_the_thread_message_alt_class(); ?>">
				<li>
                	<div class="activity-header">
                        ...
                        <div class="top-right">
                            ...
                            <span class="activity-time-since"><?php bp_the_thread_message_time_since(); ?></span>
		...
		<form id="send-reply" action="<?php bp_messages_form_action(); ?>" method="post" class="standard-form">
			...
			<div class="message-box">
				...
				<div class="message-content">
					...
					<div class="submit">
						<button id="send_reply_button" class="blue" type="submit" name="send"><?php esc_attr_e( 'Send Reply', 'buddypress' ); ?></button>
					</div>
